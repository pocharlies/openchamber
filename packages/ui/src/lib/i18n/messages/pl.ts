...
export const dict: Record<I18nKey, string> = {
  ...
  'companyOffice.navigation': 'Biuro firmy',
  'companyOffice.title': 'Biuro firmy',
  'companyOffice.hero.eyebrow': 'Centrum dowodzenia',
  'companyOffice.hero.description': 'Bieżący podgląd zespołu, sesji i pracy w Jira pod kierownictwem {ceo}.',
  'companyOffice.hero.descriptionLoading': 'Ładowanie listy pracowników, sesji i zadań Jira.',
  'companyOffice.actions.talkToCto': 'Porozmawiaj z CTO',
  'companyOffice.actions.refresh': 'Odśwież',
  'companyOffice.actions.retry': 'Spróbuj ponownie',
  'companyOffice.actions.openJira': 'Otwórz Jira',
  'companyOffice.actions.openSession': 'Otwórz sesję',
  'companyOffice.sources.roster': 'Lista pracowników',
  'companyOffice.sources.sessions': 'Sesje',
  'companyOffice.sources.activity': 'Aktywność',
  'companyOffice.sources.jira': 'Jira',
  'companyOffice.sourceState.ready': 'gotowe',
  'companyOffice.sourceState.partial': 'częściowe',
  'companyOffice.sourceState.error': 'niedostępne',
  'companyOffice.freshness': 'Zaktualizowano {time}',
  'companyOffice.error.title': 'Biuro firmy jest niedostępne',
  'companyOffice.error.description': 'Bieżące środowisko wykonawcze nie mogło utworzyć wiarygodnego obrazu firmy. Dotychczasowe dane nie zostały zastąpione pustym wynikiem.',
  'companyOffice.unavailable': 'Biuro firmy nie jest dostępne w tym środowisku.',
  'companyOffice.loading': 'Ładowanie biura firmy...',
  'companyOffice.team.title': 'Zespół',
  'companyOffice.team.description': 'Pracownicy i ich rzeczywiste sesje OpenCode.',
  'companyOffice.team.count': 'Pracownicy: {count}',
  'companyOffice.activity.busy': 'aktywny',
  'companyOffice.activity.idle': 'bezczynny',
  'companyOffice.activity.unknown': 'nieznany',
  'companyOffice.sessions.count': 'Sesje: {count}',
  'companyOffice.sessions.unavailable': 'Sesje tej osoby są niedostępne.',
  'companyOffice.initiatives.title': 'Inicjatywy',
  'companyOffice.initiatives.description': 'Historyjki w Jira i powiązane z nimi delegowane zgłoszenia.',
  'companyOffice.initiatives.empty': 'Jira nie zwróciła żadnych inicjatyw.',
  'companyOffice.jiraUnavailable': 'Jira jest niedostępna. Pustej listy zadań nie należy traktować jako wiarygodnej.',
  'companyOffice.mapping.ambiguous': 'niejednoznaczne powiązanie sesji',
  'companyOffice.mapping.reconstructed': 'Do czasu udostępnienia rejestru SC-GOV-1 powiązania sesji są odtwarzane na podstawie tytułów sesji poprzedzonych identyfikatorem zgłoszenia.',
  ...
  'chat.streamMetrics.speed': 'Szybkość',
  'chat.streamMetrics.accuracy': 'Dokładność',
  'chat.streamMetrics.estimated': 'Szacowana',
  'chat.streamMetrics.exact': 'Dokładna',
  'chat.streamMetrics.inputTokens': 'Tokeny wejściowe',
  'chat.streamMetrics.outputTokens': 'Tokeny wyjściowe',
  'chat.streamMetrics.reasoningTokens': 'Tokeny rozumowania',
  'chat.streamMetrics.cacheRead': 'Odczyt z pamięci podręcznej',
  'chat.streamMetrics.cacheWrite': 'Zapis do pamięci podręcznej',
  'chat.streamMetrics.duration': 'Łączny czas',
  'chat.streamMetrics.characters': 'Znaki',
  'chat.streamMetrics.bytes': 'Odebrane bajty',
  'chat.streamMetrics.model': 'Model',
  'chat.streamMetrics.provider': 'Dostawca',
  'chat.streamMetrics.openDetails': 'Otwórz metryki odpowiedzi ({accuracy})',
  ...
  'chat.commandAutocomplete.command.sideDescription': 'Zadaj konkretne pytanie w osobnym czacie bocznym',
  'chat.sideConversation.title': 'Czat boczny',
  'chat.sideConversation.action.open': 'Otwórz czat boczny',
  'chat.sideConversation.toast.nestingUnsupported': 'Nie można otworzyć czatu bocznego wewnątrz innego czatu bocznego',
  'chat.sideConversation.toast.openFailed': 'Nie udało się otworzyć czatu bocznego',
  'chat.sideConversation.toast.discardFailed': 'Nie udało się odrzucić czatu bocznego',
  'chat.sideConversation.toast.closeFailed': 'Nie udało się zamknąć czatu bocznego',
  'chat.sideConversation.close.title': 'Zamknąć ten czat boczny?',
  'chat.sideConversation.close.description': 'Odrzuć rozmowę lub zachowaj ją jako zwykłą sesję podrzędną.',
  'chat.sideConversation.close.cancel': 'Anuluj',
  'chat.sideConversation.close.keep': 'Zachowaj',
  'chat.sideConversation.close.discard': 'Odrzuć',
