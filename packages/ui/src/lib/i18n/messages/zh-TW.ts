...
export const dict: Record<I18nKey, string> = {
  ...
  'companyOffice.navigation': '公司辦公室',
  'companyOffice.title': '公司辦公室',
  'companyOffice.hero.eyebrow': '指揮中心',
  'companyOffice.hero.description': '即時查看由 {ceo} 領導的團隊、工作階段與 Jira 工作。',
  'companyOffice.hero.descriptionLoading': '正在載入公司人員名單、工作階段與 Jira 工作。',
  'companyOffice.actions.talkToCto': '與 CTO 交談',
  'companyOffice.actions.refresh': '重新整理',
  'companyOffice.actions.retry': '重試',
  'companyOffice.actions.openJira': '開啟 Jira',
  'companyOffice.actions.openSession': '開啟工作階段',
  'companyOffice.sources.roster': '人員名單',
  'companyOffice.sources.sessions': '工作階段',
  'companyOffice.sources.activity': '活動',
  'companyOffice.sources.jira': 'Jira',
  'companyOffice.sourceState.ready': '就緒',
  'companyOffice.sourceState.partial': '部分可用',
  'companyOffice.sourceState.error': '無法使用',
  'companyOffice.freshness': '更新於 {time}',
  'companyOffice.error.title': '公司辦公室無法使用',
  'companyOffice.error.description': '目前的執行環境無法建立可信的公司概況。現有資料未被空白結果取代。',
  'companyOffice.unavailable': '此執行環境不支援公司辦公室。',
  'companyOffice.loading': '正在載入公司辦公室...',
  'companyOffice.team.title': '團隊',
  'companyOffice.team.description': '員工及其真實的 OpenCode 工作階段。',
  'companyOffice.team.count': '{count} 位員工',
  'companyOffice.activity.busy': '活躍',
  'companyOffice.activity.idle': '閒置',
  'companyOffice.activity.unknown': '未知',
  'companyOffice.sessions.count': '{count} 個工作階段',
  'companyOffice.sessions.unavailable': '無法取得此員工的工作階段。',
  'companyOffice.initiatives.title': '計畫',
  'companyOffice.initiatives.description': 'Jira 使用者故事及其已委派的議題。',
  'companyOffice.initiatives.empty': '未傳回任何 Jira 計畫。',
  'companyOffice.jiraUnavailable': 'Jira 無法使用。這不代表工作清單確實為空。',
  'companyOffice.mapping.ambiguous': '工作階段連結不明確',
  'companyOffice.mapping.reconstructed': '在 SC-GOV-1 帳冊可用之前，工作階段連結將依據以議題編號開頭的工作階段標題重建。',
  ...
  'chat.streamMetrics.accuracy': '準確度',
  'chat.streamMetrics.estimated': '估算',
  'chat.streamMetrics.exact': '精確',
  'chat.streamMetrics.inputTokens': '輸入權杖',
  'chat.streamMetrics.outputTokens': '輸出權杖',
  'chat.streamMetrics.reasoningTokens': '推理權杖',
  'chat.streamMetrics.cacheRead': '快取讀取',
  'chat.streamMetrics.cacheWrite': '快取寫入',
  'chat.streamMetrics.duration': '總時長',
  'chat.streamMetrics.characters': '字元數',
  'chat.streamMetrics.bytes': '接收位元組數',
  'chat.streamMetrics.model': '模型',
  'chat.streamMetrics.provider': '提供者',
  'chat.streamMetrics.openDetails': '開啟回應指標（{accuracy}）',
  ...
  'chat.commandAutocomplete.command.sideDescription': '在獨立的側邊聊天中詢問具體問題',
  'chat.sideConversation.title': '側邊聊天',
  'chat.sideConversation.action.open': '開啟側邊聊天',
  'chat.sideConversation.toast.nestingUnsupported': '無法在側邊聊天中再開啟側邊聊天',
  'chat.sideConversation.toast.openFailed': '無法開啟側邊聊天',
  'chat.sideConversation.toast.discardFailed': '無法捨棄側邊聊天',
  'chat.sideConversation.toast.closeFailed': '無法關閉側邊聊天',
  'chat.sideConversation.close.title': '關閉此側邊聊天？',
  'chat.sideConversation.close.description': '捨棄對話，或將其保留為一般子工作階段。',
  'chat.sideConversation.close.cancel': '取消',
  'chat.sideConversation.close.keep': '保留',
  'chat.sideConversation.close.discard': '捨棄',
  ...
  'chat.chatInput.ghost.accept': '採用建議',
