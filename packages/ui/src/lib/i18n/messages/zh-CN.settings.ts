...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.chat.uiPlugins.section': '界面扩展',
  'settings.chat.uiPlugins.sectionInfo': '声明式扩展无需执行插件代码，即可添加由应用控制的界面功能。',
  'settings.chat.uiPlugins.sideChat.label': '侧边聊天',
  'settings.chat.uiPlugins.sideChat.aria': '启用侧边聊天扩展',
  'settings.chat.uiPlugins.sideChat.info': '添加 /btw、/side 和输入框按钮，用于临时子会话。',
  'settings.chat.uiPlugins.streamMetrics.label': '流式指标',
  'settings.chat.uiPlugins.streamMetrics.aria': '启用流式指标扩展',
  'settings.chat.uiPlugins.streamMetrics.info': '在输入框底部显示实时估算指标和最终精确响应指标。',
  'settings.chat.uiPlugins.catalogUnavailable': '无法刷新扩展目录。将继续使用上次有效的目录。',
