export const settingsDict = {
  ...
  'settings.chat.uiPlugins.section': 'Rozszerzenia interfejsu',
  'settings.chat.uiPlugins.sectionInfo': 'Rozszerzenia deklaratywne mogą dodawać funkcje kontrolowane przez aplikację bez uruchamiania kodu wtyczki.',
  'settings.chat.uiPlugins.sideChat.label': 'Czat boczny',
  'settings.chat.uiPlugins.sideChat.aria': 'Włącz rozszerzenie Czat boczny',
  'settings.chat.uiPlugins.sideChat.info': 'Dodaje /btw, /side i przycisk pola wiadomości dla tymczasowych rozmów podrzędnych.',
  'settings.chat.uiPlugins.streamMetrics.label': 'Metryki strumienia',
  'settings.chat.uiPlugins.streamMetrics.aria': 'Włącz rozszerzenie Metryki strumienia',
  'settings.chat.uiPlugins.streamMetrics.info': 'Pokazuje w stopce edytora szacowane metryki na żywo i dokładne metryki końcowe odpowiedzi.',
  'settings.chat.uiPlugins.catalogUnavailable': 'Nie udało się odświeżyć katalogu rozszerzeń. Nadal używany jest ostatni prawidłowy katalog.',
