...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  'settings.chat.uiPlugins.section': 'Extensões da interface',
  'settings.chat.uiPlugins.sectionInfo': 'Extensões declarativas podem adicionar recursos controlados pelo aplicativo sem executar código do plugin.',
  'settings.chat.uiPlugins.sideChat.label': 'Chat lateral',
  'settings.chat.uiPlugins.sideChat.aria': 'Ativar a extensão Chat lateral',
  'settings.chat.uiPlugins.sideChat.info': 'Adiciona /btw, /side e um botão no campo de mensagem para conversas filhas efêmeras.',
  'settings.chat.uiPlugins.streamMetrics.label': 'Métricas de streaming',
  'settings.chat.uiPlugins.streamMetrics.aria': 'Ativar a extensão Métricas de streaming',
  'settings.chat.uiPlugins.streamMetrics.info': 'Mostra métricas estimadas ao vivo e métricas finais exatas da resposta no rodapé do compositor.',
  'settings.chat.uiPlugins.catalogUnavailable': 'Não foi possível atualizar o catálogo de extensões. O último catálogo válido continua em uso.',
