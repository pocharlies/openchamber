...
export const dict: Record<I18nKey, string> = {
  ...
  'companyOffice.navigation': 'Escritório da empresa',
  'companyOffice.title': 'Escritório da empresa',
  'companyOffice.hero.eyebrow': 'Central de comando',
  'companyOffice.hero.description': 'Uma visão em tempo real da equipe, das sessões e do trabalho no Jira liderado por {ceo}.',
  'companyOffice.hero.descriptionLoading': 'Carregando a equipe da empresa, as sessões e o trabalho no Jira.',
  'companyOffice.actions.talkToCto': 'Falar com o CTO',
  'companyOffice.actions.refresh': 'Atualizar',
  'companyOffice.actions.retry': 'Tentar novamente',
  'companyOffice.actions.openJira': 'Abrir o Jira',
  'companyOffice.actions.openSession': 'Abrir sessão',
  'companyOffice.sources.roster': 'Equipe',
  'companyOffice.sources.sessions': 'Sessões',
  'companyOffice.sources.activity': 'Atividade',
  'companyOffice.sources.jira': 'Jira',
  'companyOffice.sourceState.ready': 'pronto',
  'companyOffice.sourceState.partial': 'parcial',
  'companyOffice.sourceState.error': 'indisponível',
  'companyOffice.freshness': 'Atualizado {time}',
  'companyOffice.error.title': 'O Escritório da empresa está indisponível',
  'companyOffice.error.description': 'O ambiente de execução atual não conseguiu gerar um retrato confiável da empresa. Os dados existentes não foram substituídos por um resultado vazio.',
  'companyOffice.unavailable': 'O Escritório da empresa não está disponível neste ambiente de execução.',
  'companyOffice.loading': 'Carregando o Escritório da empresa...',
  'companyOffice.team.title': 'Equipe',
  'companyOffice.team.description': 'Funcionários e suas sessões reais do OpenCode.',
  'companyOffice.team.count': '{count} funcionários',
  'companyOffice.activity.busy': 'ativo',
  'companyOffice.activity.idle': 'ocioso',
  'companyOffice.activity.unknown': 'desconhecido',
  'companyOffice.sessions.count': '{count} sessões',
  'companyOffice.sessions.unavailable': 'As sessões estão indisponíveis para este funcionário.',
  'companyOffice.initiatives.title': 'Iniciativas',
  'companyOffice.initiatives.description': 'Histórias do Jira e seus tickets delegados.',
  'companyOffice.initiatives.empty': 'Nenhuma iniciativa foi retornada pelo Jira.',
  'companyOffice.jiraUnavailable': 'O Jira está indisponível. Isso não significa que a lista de trabalho esteja realmente vazia.',
  'companyOffice.mapping.ambiguous': 'vínculo ambíguo da sessão',
  'companyOffice.mapping.reconstructed': 'Os vínculos das sessões são reconstruídos a partir de títulos de sessão prefixados pelo ticket até que o registro SC-GOV-1 esteja disponível.',
  ...
  'chat.streamMetrics.speed': 'Velocidade',
  'chat.streamMetrics.accuracy': 'Precisão',
  'chat.streamMetrics.estimated': 'Estimada',
  'chat.streamMetrics.exact': 'Exata',
  'chat.streamMetrics.inputTokens': 'Tokens de entrada',
  'chat.streamMetrics.outputTokens': 'Tokens de saída',
  'chat.streamMetrics.reasoningTokens': 'Tokens de raciocínio',
  'chat.streamMetrics.cacheRead': 'Cache lido',
  'chat.streamMetrics.cacheWrite': 'Cache gravado',
  'chat.streamMetrics.duration': 'Duração total',
  'chat.streamMetrics.characters': 'Caracteres',
  'chat.streamMetrics.bytes': 'Bytes recebidos',
  'chat.streamMetrics.model': 'Modelo',
  'chat.streamMetrics.provider': 'Provedor',
  'chat.streamMetrics.openDetails': 'Abrir métricas da resposta ({accuracy})',
  ...
  "chat.commandAutocomplete.command.sideDescription": "Fazer uma pergunta específica em um chat lateral separado",
  "chat.sideConversation.title": "Chat lateral",
  "chat.sideConversation.action.open": "Abrir chat lateral",
  "chat.sideConversation.toast.nestingUnsupported": "Não é possível abrir um chat lateral dentro de outro",
  "chat.sideConversation.toast.openFailed": "Não foi possível abrir o chat lateral",
  "chat.sideConversation.toast.discardFailed": "Não foi possível descartar o chat lateral",
  "chat.sideConversation.toast.closeFailed": "Não foi possível fechar o chat lateral",
  "chat.sideConversation.close.title": "Fechar este chat lateral?",
  "chat.sideConversation.close.description": "Descarte a conversa ou mantenha-a como uma sessão filha normal.",
  "chat.sideConversation.close.cancel": "Cancelar",
  "chat.sideConversation.close.keep": "Manter",
  "chat.sideConversation.close.discard": "Descartar",
  ...
  "chat.chatInput.ghost.accept": "Aceitar sugestao",
