...
export const dict: Record<I18nKey, string> = {
  ...
  "companyOffice.navigation": "Oficina de la empresa",
  "companyOffice.title": "Oficina de la empresa",
  "companyOffice.hero.eyebrow": "Centro de mando",
  "companyOffice.hero.description": "Vista en directo del equipo, las sesiones y el trabajo de Jira dirigido por {ceo}.",
  "companyOffice.hero.descriptionLoading": "Cargando el equipo, las sesiones y el trabajo de Jira.",
  "companyOffice.actions.talkToCto": "Hablar con el CTO",
  "companyOffice.actions.refresh": "Actualizar",
  "companyOffice.actions.retry": "Reintentar",
  "companyOffice.actions.openJira": "Abrir Jira",
  "companyOffice.actions.openSession": "Abrir sesión",
  "companyOffice.sources.roster": "Equipo",
  "companyOffice.sources.sessions": "Sesiones",
  "companyOffice.sources.activity": "Actividad",
  "companyOffice.sources.jira": "Jira",
  "companyOffice.sourceState.ready": "disponible",
  "companyOffice.sourceState.partial": "parcial",
  "companyOffice.sourceState.error": "no disponible",
  "companyOffice.freshness": "Actualizado a las {time}",
  "companyOffice.error.title": "La oficina de la empresa no está disponible",
  "companyOffice.error.description": "El entorno actual no pudo generar una vista fiable de la empresa. Los datos existentes no se sustituyeron por un resultado vacío.",
  "companyOffice.unavailable": "La oficina de la empresa no está disponible en este entorno.",
  "companyOffice.loading": "Cargando la oficina de la empresa...",
  "companyOffice.team.title": "Equipo",
  "companyOffice.team.description": "Empleados y sus sesiones reales de OpenCode.",
  "companyOffice.team.count": "{count} empleados",
  "companyOffice.activity.busy": "activo",
  "companyOffice.activity.idle": "inactivo",
  "companyOffice.activity.unknown": "desconocido",
  "companyOffice.sessions.count": "{count} sesiones",
  "companyOffice.sessions.unavailable": "Las sesiones de este empleado no están disponibles.",
  "companyOffice.initiatives.title": "Iniciativas",
  "companyOffice.initiatives.description": "Historias de Jira y sus tickets delegados.",
  "companyOffice.initiatives.empty": "Jira no devolvió ninguna iniciativa.",
  "companyOffice.jiraUnavailable": "Jira no está disponible. Esto no es una lista de trabajo vacía y autoritativa.",
  "companyOffice.mapping.ambiguous": "enlace de sesión ambiguo",
  "companyOffice.mapping.reconstructed": "Los enlaces de sesión se reconstruyen a partir de títulos con prefijo de ticket hasta que esté disponible el ledger SC-GOV-1.",
  ...
  'chat.streamMetrics.speed': 'Velocidad',
  'chat.streamMetrics.accuracy': 'Exactitud',
  'chat.streamMetrics.estimated': 'Estimada',
  'chat.streamMetrics.exact': 'Exacta',
  'chat.streamMetrics.inputTokens': 'Tokens de entrada',
  'chat.streamMetrics.outputTokens': 'Tokens de salida',
  'chat.streamMetrics.reasoningTokens': 'Tokens de razonamiento',
  'chat.streamMetrics.cacheRead': 'Caché leída',
  'chat.streamMetrics.cacheWrite': 'Caché escrita',
  'chat.streamMetrics.duration': 'Duración total',
  'chat.streamMetrics.characters': 'Caracteres',
  'chat.streamMetrics.bytes': 'Bytes recibidos',
  'chat.streamMetrics.model': 'Modelo',
  'chat.streamMetrics.provider': 'Proveedor',
  'chat.streamMetrics.openDetails': 'Abrir métricas de la respuesta ({accuracy})',
  ...
  "chat.commandAutocomplete.command.sideDescription": "Hacer una pregunta concreta en un chat lateral separado",
  "chat.sideConversation.title": "Chat lateral",
  "chat.sideConversation.action.open": "Abrir chat lateral",
  "chat.sideConversation.toast.nestingUnsupported": "No se puede abrir un chat lateral dentro de otro chat lateral",
  "chat.sideConversation.toast.openFailed": "No se pudo abrir el chat lateral",
  "chat.sideConversation.toast.discardFailed": "No se pudo descartar el chat lateral",
  "chat.sideConversation.toast.closeFailed": "No se pudo cerrar el chat lateral",
  "chat.sideConversation.close.title": "¿Cerrar este chat lateral?",
  "chat.sideConversation.close.description": "Descarta su conversación o consérvalo como una sesión hija normal.",
  "chat.sideConversation.close.cancel": "Cancelar",
  "chat.sideConversation.close.keep": "Conservar",
