...
export const dict = {
  ...
  'companyOffice.navigation': 'Bureau de l’entreprise',
  'companyOffice.title': 'Bureau de l’entreprise',
  'companyOffice.hero.eyebrow': 'Centre de commandement',
  'companyOffice.hero.description': 'Une vue en temps réel de l’équipe, des sessions et des tâches Jira pilotées par {ceo}.',
  'companyOffice.hero.descriptionLoading': 'Chargement de l’effectif, des sessions et des tâches Jira de l’entreprise.',
  'companyOffice.actions.talkToCto': 'Parler au CTO',
  'companyOffice.actions.refresh': 'Actualiser',
  'companyOffice.actions.retry': 'Réessayer',
  'companyOffice.actions.openJira': 'Ouvrir Jira',
  'companyOffice.actions.openSession': 'Ouvrir la session',
  'companyOffice.sources.roster': 'Effectif',
  'companyOffice.sources.sessions': 'Sessions',
  'companyOffice.sources.activity': 'Activité',
  'companyOffice.sources.jira': 'Jira',
  'companyOffice.sourceState.ready': 'prêt',
  'companyOffice.sourceState.partial': 'partiel',
  'companyOffice.sourceState.error': 'indisponible',
  'companyOffice.freshness': 'Mis à jour {time}',
  'companyOffice.error.title': 'Le Bureau de l’entreprise est indisponible',
  'companyOffice.error.description': 'L’environnement d’exécution actuel n’a pas pu produire un état fiable de l’entreprise. Les données existantes n’ont pas été remplacées par un résultat vide.',
  'companyOffice.unavailable': 'Le Bureau de l’entreprise n’est pas disponible dans cet environnement d’exécution.',
  'companyOffice.loading': 'Chargement du Bureau de l’entreprise...',
  'companyOffice.team.title': 'Équipe',
  'companyOffice.team.description': 'Les employés et leurs véritables sessions OpenCode.',
  'companyOffice.team.count': '{count} employés',
  'companyOffice.activity.busy': 'actif',
  'companyOffice.activity.idle': 'inactif',
  'companyOffice.activity.unknown': 'inconnu',
  'companyOffice.sessions.count': '{count} sessions',
  'companyOffice.sessions.unavailable': 'Les sessions ne sont pas disponibles pour cet employé.',
  'companyOffice.initiatives.title': 'Initiatives',
  'companyOffice.initiatives.description': 'Les stories Jira et les tickets délégués qui leur sont associés.',
  'companyOffice.initiatives.empty': 'Aucune initiative Jira n’a été renvoyée.',
  'companyOffice.jiraUnavailable': 'Jira est indisponible. Cela ne signifie pas de manière certaine que la liste des tâches est vide.',
  'companyOffice.mapping.ambiguous': 'lien de session ambigu',
  'companyOffice.mapping.reconstructed': 'Les liens de session sont reconstitués à partir des titres de session préfixés par un numéro de ticket jusqu’à ce que le registre SC-GOV-1 soit disponible.',
  ...
  'chat.streamMetrics.speed': 'Vitesse',
  'chat.streamMetrics.accuracy': 'Précision',
  'chat.streamMetrics.estimated': 'Estimée',
  'chat.streamMetrics.exact': 'Exacte',
  'chat.streamMetrics.inputTokens': 'Jetons d’entrée',
  'chat.streamMetrics.outputTokens': 'Jetons de sortie',
  'chat.streamMetrics.reasoningTokens': 'Jetons de raisonnement',
  'chat.streamMetrics.cacheRead': 'Cache lu',
  'chat.streamMetrics.cacheWrite': 'Cache écrit',
  'chat.streamMetrics.duration': 'Durée totale',
  'chat.streamMetrics.characters': 'Caractères',
  'chat.streamMetrics.bytes': 'Octets reçus',
  'chat.streamMetrics.model': 'Modèle',
  'chat.streamMetrics.provider': 'Fournisseur',
  'chat.streamMetrics.openDetails': 'Ouvrir les métriques de réponse ({accuracy})',
  ...
  'chat.commandAutocomplete.command.sideDescription': 'Poser une question ciblée dans une discussion latérale séparée',
  'chat.sideConversation.title': 'Discussion latérale',
  'chat.sideConversation.action.open': 'Ouvrir une discussion latérale',
  'chat.sideConversation.toast.nestingUnsupported': 'Une discussion latérale ne peut pas être ouverte dans une autre',
  'chat.sideConversation.toast.openFailed': 'Impossible d\'ouvrir la discussion latérale',
  'chat.sideConversation.toast.discardFailed': 'Impossible de supprimer la discussion latérale',
  'chat.sideConversation.toast.closeFailed': 'Impossible de fermer la discussion latérale',
  'chat.sideConversation.close.title': 'Fermer cette discussion latérale ?',
  'chat.sideConversation.close.description': 'Supprimez sa conversation ou conservez-la comme session enfant normale.',
  'chat.sideConversation.close.cancel': 'Annuler',
  'chat.sideConversation.close.keep': 'Conserver',
  'chat.sideConversation.close.discard': 'Supprimer',
