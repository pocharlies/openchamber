...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.chat.uiPlugins.section': 'UI 확장 기능',
  'settings.chat.uiPlugins.sectionInfo': '선언형 확장 기능은 플러그인 코드를 실행하지 않고 앱이 제어하는 인터페이스 기능을 추가할 수 있습니다.',
  'settings.chat.uiPlugins.sideChat.label': '사이드 채팅',
  'settings.chat.uiPlugins.sideChat.aria': '사이드 채팅 확장 기능 사용',
  'settings.chat.uiPlugins.sideChat.info': '임시 하위 대화를 위한 /btw, /side 및 입력창 버튼을 추가합니다.',
  'settings.chat.uiPlugins.streamMetrics.label': '스트리밍 측정값',
  'settings.chat.uiPlugins.streamMetrics.aria': '스트리밍 측정값 확장 기능 사용',
  'settings.chat.uiPlugins.streamMetrics.info': '입력창 바닥글에 실시간 추정 응답 측정값과 최종 정확한 측정값을 표시합니다.',
  'settings.chat.uiPlugins.catalogUnavailable': '확장 기능 카탈로그를 새로 고칠 수 없습니다. 마지막으로 유효한 카탈로그를 계속 사용합니다.',
