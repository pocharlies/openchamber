...
export const dict: Record<I18nKey, string> = {
  ...
  'companyOffice.navigation': '회사 오피스',
  'companyOffice.title': '회사 오피스',
  'companyOffice.hero.eyebrow': '통합 상황실',
  'companyOffice.hero.description': '{ceo}가 이끄는 팀과 세션, Jira 업무를 실시간으로 확인하세요.',
  'companyOffice.hero.descriptionLoading': '회사 구성원 명단과 세션, Jira 업무를 불러오는 중입니다.',
  'companyOffice.actions.talkToCto': 'CTO와 대화하기',
  'companyOffice.actions.refresh': '새로고침',
  'companyOffice.actions.retry': '다시 시도',
  'companyOffice.actions.openJira': 'Jira 열기',
  'companyOffice.actions.openSession': '세션 열기',
  'companyOffice.sources.roster': '구성원 명단',
  'companyOffice.sources.sessions': '세션',
  'companyOffice.sources.activity': '활동',
  'companyOffice.sources.jira': 'Jira',
  'companyOffice.sourceState.ready': '준비됨',
  'companyOffice.sourceState.partial': '일부만 사용 가능',
  'companyOffice.sourceState.error': '사용 불가',
  'companyOffice.freshness': '업데이트: {time}',
  'companyOffice.error.title': '회사 오피스를 사용할 수 없습니다',
  'companyOffice.error.description': '현재 런타임에서 신뢰할 수 있는 회사 현황을 생성하지 못했습니다. 기존 데이터는 빈 결과로 대체되지 않았습니다.',
  'companyOffice.unavailable': '이 런타임에서는 회사 오피스를 사용할 수 없습니다.',
  'companyOffice.loading': '회사 오피스 불러오는 중...',
  'companyOffice.team.title': '팀',
  'companyOffice.team.description': '직원과 이들이 실제로 사용하는 OpenCode 세션입니다.',
  'companyOffice.team.count': '직원 {count}명',
  'companyOffice.activity.busy': '활동 중',
  'companyOffice.activity.idle': '대기 중',
  'companyOffice.activity.unknown': '알 수 없음',
  'companyOffice.sessions.count': '세션 {count}개',
  'companyOffice.sessions.unavailable': '이 직원의 세션을 사용할 수 없습니다.',
  'companyOffice.initiatives.title': '이니셔티브',
  'companyOffice.initiatives.description': 'Jira 스토리와 해당 스토리에서 위임된 티켓입니다.',
  'companyOffice.initiatives.empty': 'Jira에서 반환된 이니셔티브가 없습니다.',
  'companyOffice.jiraUnavailable': 'Jira를 사용할 수 없습니다. 따라서 빈 업무 목록으로 간주할 수 없습니다.',
  'companyOffice.mapping.ambiguous': '세션 연결이 불분명함',
  'companyOffice.mapping.reconstructed': 'SC-GOV-1 원장이 제공될 때까지 티켓 접두사가 붙은 세션 제목을 바탕으로 세션 링크를 재구성합니다.',
  ...
  'chat.streamMetrics.speed': '속도',
  'chat.streamMetrics.accuracy': '정확도',
  'chat.streamMetrics.estimated': '추정',
  'chat.streamMetrics.exact': '정확',
  'chat.streamMetrics.inputTokens': '입력 토큰',
  'chat.streamMetrics.outputTokens': '출력 토큰',
  'chat.streamMetrics.reasoningTokens': '추론 토큰',
  'chat.streamMetrics.cacheRead': '캐시 읽기',
  'chat.streamMetrics.cacheWrite': '캐시 쓰기',
  'chat.streamMetrics.duration': '총 소요 시간',
  'chat.streamMetrics.characters': '문자 수',
  'chat.streamMetrics.bytes': '수신 바이트',
  'chat.streamMetrics.model': '모델',
  'chat.streamMetrics.provider': '제공자',
  'chat.streamMetrics.openDetails': '응답 측정값 열기({accuracy})',
  ...
  'chat.commandAutocomplete.command.sideDescription': '별도의 사이드 채팅에서 구체적인 질문을 합니다',
  'chat.sideConversation.title': '사이드 채팅',
  'chat.sideConversation.action.open': '사이드 채팅 열기',
  'chat.sideConversation.toast.nestingUnsupported': '사이드 채팅 안에서는 다른 사이드 채팅을 열 수 없습니다',
  'chat.sideConversation.toast.openFailed': '사이드 채팅을 열지 못했습니다',
  'chat.sideConversation.toast.discardFailed': '사이드 채팅을 삭제하지 못했습니다',
  'chat.sideConversation.toast.closeFailed': '사이드 채팅을 닫지 못했습니다',
  'chat.sideConversation.close.title': '이 사이드 채팅을 닫을까요?',
  'chat.sideConversation.close.description': '대화를 삭제하거나 일반 하위 세션으로 보관합니다.',
  'chat.sideConversation.close.cancel': '취소',
  'chat.sideConversation.close.keep': '보관',
  'chat.sideConversation.close.discard': '삭제',
