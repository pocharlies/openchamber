export const settingsDict = {
  ...
  'settings.chat.uiPlugins.section': 'UI extensions',
  'settings.chat.uiPlugins.sectionInfo': 'Declarative extensions can add host-controlled interface features without executing plugin code.',
  'settings.chat.uiPlugins.sideChat.label': 'Side Chat',
  'settings.chat.uiPlugins.sideChat.aria': 'Enable the Side Chat extension',
  'settings.chat.uiPlugins.sideChat.info': 'Adds /btw, /side, and a composer button for ephemeral child conversations.',
  'settings.chat.uiPlugins.streamMetrics.label': 'Stream Metrics',
  'settings.chat.uiPlugins.streamMetrics.aria': 'Enable the Stream Metrics extension',
  'settings.chat.uiPlugins.streamMetrics.info': 'Shows live estimated and final exact response metrics in the composer footer.',
  'settings.chat.uiPlugins.catalogUnavailable': 'The extension catalog could not be refreshed. The last valid catalog is still in use.',
