...
export const dict = {
  ...
  'companyOffice.navigation': 'Company Office',
  'companyOffice.title': 'Company Office',
  'companyOffice.hero.eyebrow': 'Command center',
  'companyOffice.hero.description': 'A live view of the team, sessions, and Jira work led by {ceo}.',
  'companyOffice.hero.descriptionLoading': 'Loading the company roster, sessions, and Jira work.',
  'companyOffice.actions.talkToCto': 'Talk to CTO',
  'companyOffice.actions.refresh': 'Refresh',
  'companyOffice.actions.retry': 'Retry',
  'companyOffice.actions.openJira': 'Open Jira',
  'companyOffice.actions.openSession': 'Open session',
  'companyOffice.sources.roster': 'Roster',
  'companyOffice.sources.sessions': 'Sessions',
  'companyOffice.sources.activity': 'Activity',
  'companyOffice.sources.jira': 'Jira',
  'companyOffice.sourceState.ready': 'ready',
  'companyOffice.sourceState.partial': 'partial',
  'companyOffice.sourceState.error': 'unavailable',
  'companyOffice.freshness': 'Updated {time}',
  'companyOffice.error.title': 'Company Office is unavailable',
  'companyOffice.error.description': 'The current runtime could not build a trusted company snapshot. Existing data was not replaced with an empty result.',
  'companyOffice.unavailable': 'Company Office is not available on this runtime.',
  'companyOffice.loading': 'Loading Company Office...',
  'companyOffice.team.title': 'Team',
  'companyOffice.team.description': 'Employees and their real OpenCode sessions.',
  'companyOffice.team.count': '{count} employees',
  'companyOffice.activity.busy': 'active',
  'companyOffice.activity.idle': 'idle',
  'companyOffice.activity.unknown': 'unknown',
  'companyOffice.sessions.count': '{count} sessions',
  'companyOffice.sessions.unavailable': 'Sessions are unavailable for this employee.',
  'companyOffice.initiatives.title': 'Initiatives',
  'companyOffice.initiatives.description': 'Jira stories and their delegated tickets.',
  'companyOffice.initiatives.empty': 'No Jira initiatives were returned.',
  'companyOffice.jiraUnavailable': 'Jira is unavailable. This is not an authoritative empty work list.',
  'companyOffice.mapping.ambiguous': 'ambiguous session link',
  'companyOffice.mapping.reconstructed': 'Session links are reconstructed from ticket-prefixed session titles until the SC-GOV-1 ledger is available.',
  ...
  'chat.streamMetrics.speed': 'Speed',
  'chat.streamMetrics.accuracy': 'Accuracy',
  'chat.streamMetrics.estimated': 'Estimated',
  'chat.streamMetrics.exact': 'Exact',
  'chat.streamMetrics.inputTokens': 'Input tokens',
  'chat.streamMetrics.outputTokens': 'Output tokens',
  'chat.streamMetrics.reasoningTokens': 'Reasoning tokens',
  'chat.streamMetrics.cacheRead': 'Cache read',
  'chat.streamMetrics.cacheWrite': 'Cache write',
  'chat.streamMetrics.duration': 'Total duration',
  'chat.streamMetrics.characters': 'Characters',
  'chat.streamMetrics.bytes': 'Bytes received',
  'chat.streamMetrics.model': 'Model',
  'chat.streamMetrics.provider': 'Provider',
  'chat.streamMetrics.openDetails': 'Open response metrics ({accuracy})',
  ...
  'chat.commandAutocomplete.command.sideDescription': 'Ask a focused question in a separate side chat',
  'chat.sideConversation.title': 'Side chat',
  'chat.sideConversation.action.open': 'Open side chat',
  'chat.sideConversation.toast.nestingUnsupported': 'Side chats cannot be opened inside another side chat',
  'chat.sideConversation.toast.openFailed': 'Failed to open side chat',
  'chat.sideConversation.toast.discardFailed': 'Failed to discard side chat',
  'chat.sideConversation.toast.closeFailed': 'Failed to close side chat',
  'chat.sideConversation.close.title': 'Close this side chat?',
  'chat.sideConversation.close.description': 'Discard its conversation or keep it as a normal child session.',
  'chat.sideConversation.close.cancel': 'Cancel',
  'chat.sideConversation.close.keep': 'Keep',
  'chat.sideConversation.close.discard': 'Discard',
