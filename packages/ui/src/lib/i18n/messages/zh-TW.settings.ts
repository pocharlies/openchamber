...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.chat.uiPlugins.section': '介面擴充功能',
  'settings.chat.uiPlugins.sectionInfo': '宣告式擴充功能無須執行外掛程式碼，即可加入由應用程式控制的介面功能。',
  'settings.chat.uiPlugins.sideChat.label': '側邊聊天',
  'settings.chat.uiPlugins.sideChat.aria': '啟用側邊聊天擴充功能',
  'settings.chat.uiPlugins.sideChat.info': '加入 /btw、/side 和輸入框按鈕，用於暫時性的子對話。',
  'settings.chat.uiPlugins.streamMetrics.label': '串流指標',
  'settings.chat.uiPlugins.streamMetrics.aria': '啟用串流指標擴充功能',
  'settings.chat.uiPlugins.streamMetrics.info': '在輸入框底部顯示即時估算指標與最終精確回應指標。',
  'settings.chat.uiPlugins.catalogUnavailable': '無法重新整理擴充功能目錄。將繼續使用上次有效的目錄。',
