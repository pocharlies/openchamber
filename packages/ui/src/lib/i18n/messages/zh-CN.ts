...
export const dict: Record<I18nKey, string> = {
  ...
  'companyOffice.navigation': '公司办公室',
  'companyOffice.title': '公司办公室',
  'companyOffice.hero.eyebrow': '指挥中心',
  'companyOffice.hero.description': '实时查看由 {ceo} 领导的团队、会话和 Jira 工作。',
  'companyOffice.hero.descriptionLoading': '正在加载公司人员名单、会话和 Jira 工作。',
  'companyOffice.actions.talkToCto': '与 CTO 交谈',
  'companyOffice.actions.refresh': '刷新',
  'companyOffice.actions.retry': '重试',
  'companyOffice.actions.openJira': '打开 Jira',
  'companyOffice.actions.openSession': '打开会话',
  'companyOffice.sources.roster': '人员名单',
  'companyOffice.sources.sessions': '会话',
  'companyOffice.sources.activity': '活动',
  'companyOffice.sources.jira': 'Jira',
  'companyOffice.sourceState.ready': '就绪',
  'companyOffice.sourceState.partial': '部分可用',
  'companyOffice.sourceState.error': '不可用',
  'companyOffice.freshness': '更新于 {time}',
  'companyOffice.error.title': '公司办公室不可用',
  'companyOffice.error.description': '当前运行环境无法生成可信的公司概览。现有数据未被空结果替换。',
  'companyOffice.unavailable': '当前运行环境不支持公司办公室。',
  'companyOffice.loading': '正在加载公司办公室...',
  'companyOffice.team.title': '团队',
  'companyOffice.team.description': '员工及其真实的 OpenCode 会话。',
  'companyOffice.team.count': '{count} 名员工',
  'companyOffice.activity.busy': '活跃',
  'companyOffice.activity.idle': '空闲',
  'companyOffice.activity.unknown': '未知',
  'companyOffice.sessions.count': '{count} 个会话',
  'companyOffice.sessions.unavailable': '无法获取该员工的会话。',
  'companyOffice.initiatives.title': '计划',
  'companyOffice.initiatives.description': 'Jira 用户故事及其已委派的工单。',
  'companyOffice.initiatives.empty': '未返回任何 Jira 计划。',
  'companyOffice.jiraUnavailable': 'Jira 不可用。这并不表示工作列表确实为空。',
  'companyOffice.mapping.ambiguous': '会话链接不明确',
  'companyOffice.mapping.reconstructed': '在 SC-GOV-1 台账可用之前，会话链接将根据以工单编号开头的会话标题重建。',
  ...
  'chat.streamMetrics.accuracy': '准确度',
  'chat.streamMetrics.estimated': '估算',
  'chat.streamMetrics.exact': '精确',
  'chat.streamMetrics.inputTokens': '输入令牌',
  'chat.streamMetrics.outputTokens': '输出令牌',
  'chat.streamMetrics.reasoningTokens': '推理令牌',
  'chat.streamMetrics.cacheRead': '缓存读取',
  'chat.streamMetrics.cacheWrite': '缓存写入',
  'chat.streamMetrics.duration': '总时长',
  'chat.streamMetrics.characters': '字符数',
  'chat.streamMetrics.bytes': '接收字节数',
  'chat.streamMetrics.model': '模型',
  'chat.streamMetrics.provider': '提供商',
  'chat.streamMetrics.openDetails': '打开响应指标（{accuracy}）',
  ...
  'chat.commandAutocomplete.command.sideDescription': '在单独的侧边聊天中询问具体问题',
  'chat.sideConversation.title': '侧边聊天',
  'chat.sideConversation.action.open': '打开侧边聊天',
  'chat.sideConversation.toast.nestingUnsupported': '不能在侧边聊天中再打开侧边聊天',
  'chat.sideConversation.toast.openFailed': '无法打开侧边聊天',
  'chat.sideConversation.toast.discardFailed': '无法丢弃侧边聊天',
  'chat.sideConversation.toast.closeFailed': '无法关闭侧边聊天',
  'chat.sideConversation.close.title': '关闭此侧边聊天？',
  'chat.sideConversation.close.description': '丢弃对话，或将其保留为普通子会话。',
  'chat.sideConversation.close.cancel': '取消',
  'chat.sideConversation.close.keep': '保留',
  'chat.sideConversation.close.discard': '丢弃',
