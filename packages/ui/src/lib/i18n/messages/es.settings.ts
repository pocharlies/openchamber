...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  'settings.chat.uiPlugins.section': 'Extensiones de interfaz',
  'settings.chat.uiPlugins.sectionInfo': 'Las extensiones declarativas pueden añadir funciones controladas por la aplicación sin ejecutar código del plugin.',
  'settings.chat.uiPlugins.sideChat.label': 'Chat lateral',
  'settings.chat.uiPlugins.sideChat.aria': 'Activar la extensión Chat lateral',
  'settings.chat.uiPlugins.sideChat.info': 'Añade /btw, /side y un botón en el compositor para conversaciones hijas efímeras.',
  'settings.chat.uiPlugins.streamMetrics.label': 'Métricas de streaming',
  'settings.chat.uiPlugins.streamMetrics.aria': 'Activar la extensión Métricas de streaming',
  'settings.chat.uiPlugins.streamMetrics.info': 'Muestra métricas estimadas en vivo y métricas finales exactas en el pie del compositor.',
  'settings.chat.uiPlugins.catalogUnavailable': 'No se pudo actualizar el catálogo de extensiones. Se sigue usando el último catálogo válido.',
