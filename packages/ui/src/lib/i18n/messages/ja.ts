...
export const dict: Record<I18nKey, string> = {
  ...
  'companyOffice.navigation': '社内オフィス',
  'companyOffice.title': '社内オフィス',
  'companyOffice.hero.eyebrow': 'コマンドセンター',
  'companyOffice.hero.description': '{ceo}が率いるチーム、セッション、Jiraの作業状況をリアルタイムで表示します。',
  'companyOffice.hero.descriptionLoading': '社内のメンバー、セッション、Jiraの作業を読み込んでいます。',
  'companyOffice.actions.talkToCto': 'CTOと話す',
  'companyOffice.actions.refresh': '更新',
  'companyOffice.actions.retry': '再試行',
  'companyOffice.actions.openJira': 'Jiraを開く',
  'companyOffice.actions.openSession': 'セッションを開く',
  'companyOffice.sources.roster': 'メンバー',
  'companyOffice.sources.sessions': 'セッション',
  'companyOffice.sources.activity': 'アクティビティ',
  'companyOffice.sources.jira': 'Jira',
  'companyOffice.sourceState.ready': '正常',
  'companyOffice.sourceState.partial': '一部のみ',
  'companyOffice.sourceState.error': '利用不可',
  'companyOffice.freshness': '更新: {time}',
  'companyOffice.error.title': '社内オフィスを利用できません',
  'companyOffice.error.description': '現在の実行環境では、信頼できる社内状況を取得できませんでした。既存のデータは空の結果で置き換えられていません。',
  'companyOffice.unavailable': 'この実行環境では社内オフィスを利用できません。',
  'companyOffice.loading': '社内オフィスを読み込んでいます...',
  'companyOffice.team.title': 'チーム',
  'companyOffice.team.description': '従業員と、各自が実際に使用しているOpenCodeセッションです。',
  'companyOffice.team.count': '{count}人の従業員',
  'companyOffice.activity.busy': '稼働中',
  'companyOffice.activity.idle': '待機中',
  'companyOffice.activity.unknown': '不明',
  'companyOffice.sessions.count': '{count}件のセッション',
  'companyOffice.sessions.unavailable': 'この従業員のセッションは利用できません。',
  'companyOffice.initiatives.title': 'イニシアチブ',
  'companyOffice.initiatives.description': 'Jiraのストーリーと、それぞれに関連する委任済みチケットです。',
  'companyOffice.initiatives.empty': 'Jiraからイニシアチブが返されませんでした。',
  'companyOffice.jiraUnavailable': 'Jiraを利用できません。このため、作業リストが空だとは断定できません。',
  'companyOffice.mapping.ambiguous': 'セッションの関連付けが不明確',
  'companyOffice.mapping.reconstructed': 'SC-GOV-1台帳が利用可能になるまでは、チケット番号で始まるセッションタイトルからセッションの関連付けを再構築します。',
  ...
  'chat.streamMetrics.speed': '速度',
  'chat.streamMetrics.accuracy': '精度',
  'chat.streamMetrics.estimated': '推定',
  'chat.streamMetrics.exact': '正確',
  'chat.streamMetrics.inputTokens': '入力トークン',
  'chat.streamMetrics.outputTokens': '出力トークン',
  'chat.streamMetrics.reasoningTokens': '推論トークン',
  'chat.streamMetrics.cacheRead': 'キャッシュ読み取り',
  'chat.streamMetrics.cacheWrite': 'キャッシュ書き込み',
  'chat.streamMetrics.duration': '合計時間',
  'chat.streamMetrics.characters': '文字数',
  'chat.streamMetrics.bytes': '受信バイト数',
  'chat.streamMetrics.model': 'モデル',
  'chat.streamMetrics.provider': 'プロバイダー',
  'chat.streamMetrics.openDetails': '応答指標を開く（{accuracy}）',
  ...
  'chat.commandAutocomplete.command.sideDescription': '別のサイドチャットで具体的な質問をする',
  'chat.sideConversation.title': 'サイドチャット',
  'chat.sideConversation.action.open': 'サイドチャットを開く',
  'chat.sideConversation.toast.nestingUnsupported': 'サイドチャット内で別のサイドチャットを開くことはできません',
  'chat.sideConversation.toast.openFailed': 'サイドチャットを開けませんでした',
  'chat.sideConversation.toast.discardFailed': 'サイドチャットを破棄できませんでした',
  'chat.sideConversation.toast.closeFailed': 'サイドチャットを閉じられませんでした',
  'chat.sideConversation.close.title': 'このサイドチャットを閉じますか？',
  'chat.sideConversation.close.description': '会話を破棄するか、通常の子セッションとして保存します。',
  'chat.sideConversation.close.cancel': 'キャンセル',
  'chat.sideConversation.close.keep': '保存',
  'chat.sideConversation.close.discard': '破棄',
